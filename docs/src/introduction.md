...
The version of the plugin covered by this document implements version 1.2 of the [Container Storage Interface (CSI) Specification](https://github.com/container-storage-interface/spec/blob/v1.2.0/spec.md), and is compatible with Lightbits™ version 3.14.1.

> **NOTE:**
>
> If you upgrade the Lightbits cluster to version 3.14.1 it is recommended to upgrade the CSI plugin to version 1.18.0 as well.
